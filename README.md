...
├── notebooks/
│   └── MiniBioDesignBench_Colab.ipynb
└── src/
    ├── __init__.py
    ├── agents.py
    ├── grader.py
